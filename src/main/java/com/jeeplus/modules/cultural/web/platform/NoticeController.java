...
import com.jeeplus.modules.cultural.service.platform.NoticeService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/cultural/platform/notice")
public class NoticeController extends BaseController {
	 ...
	 * 公告列表页面
	 */
	@RequiresPermissions("cultural:platform:notice:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "modules/cultural/platform/noticeList";
	}
	 ...
	 * 查看，增加，编辑公告表单页面
	 */
	@RequiresPermissions(value={"cultural:platform:notice:view","cultural:platform:notice:add","cultural:platform:notice:edit"},logical=Logical.OR)
	@RequestMapping(value = "form")
	public String form(Notice notice, Model model) {
		model.addAttribute("notice", notice);
		return "modules/cultural/platform/noticeForm";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions(value={"cultural:platform:notice:add","cultural:platform:notice:edit"},logical=Logical.OR)
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("cultural:platform:notice:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("cultural:platform:notice:export")
	 ...
	 */
	@RequiresPermissions("cultural:platform:notice:import")
    ...
    public String importFile(MultipartFile file, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/cultural/platform/notice/?repage";
    }
