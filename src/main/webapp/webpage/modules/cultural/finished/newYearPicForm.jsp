		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/cultural/finished/newYearPic/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="newYearPic" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:radiobuttons path="type" items="${fns:getDictList('cultural_newYearPic')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks "/>
					</td>
				</tr>
				<tr>
					...
					<td class="width-35">
						...
						<sys:ckfinder input="picture" type="files" uploadPath="/cultural/finished/newYearPic" selectMultiple="true"/>
					</td>
					<td class="width-15 active"><label class="pull-right">简介：</label></td>
					<td class="width-35">
						<form:textarea path="intro" htmlEscape="false" rows="4" maxlength="32"  minlength="2"   class="form-control "/>
					</td>
				</tr>
				<tr>
					...
					<td class="width-35">
						...
						<div id="details">
                          ${fns:unescapeHtml(newYearPic.details)}
                        </div>
					</td>
