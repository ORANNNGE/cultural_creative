		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/cultural/finished/calligraphy/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="calligraphy" class="form-horizontal">
		<form:hidden path="id"/>
		   ...
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						...
						<sys:ckfinder input="picture" type="files" uploadPath="/cultural/finished/calligraphy" selectMultiple="true"/>
					</td>
