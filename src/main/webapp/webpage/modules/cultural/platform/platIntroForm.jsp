		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/cultural/platform/platIntro/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="platIntro" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<tr>
					...
					<td class="width-55">
                      <%--  <input type="hidden" name="intro"/>
						<div id="intro">
                          ${fns:unescapeHtml(platIntro.intro)}
                        </div>--%>
						  <form:hidden path="intro" htmlEscape="true"/>
