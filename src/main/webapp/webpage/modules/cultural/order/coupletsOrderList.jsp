...
<head>
	...
	<%@include file="coupletsOrderList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">成品楹联订单列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="coupletsOrder" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="成品楹联：">成品楹联：</label>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<sys:gridselect url="${ctx}/cultural/role/installer/data" id="installer" name="installer.id" value="${coupletsOrder.installer.id}" labelName="installer.name" labelValue="${coupletsOrder.installer.name}"
					title="选择安装人员" cssClass="form-control required" fieldLabels="安装人员" fieldKeys="name" searchLabels="安装人员" searchKeys="name" ></sys:gridselect>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="cultural:order:coupletsOrder:add">
			...
			<shiro:hasPermission name="cultural:order:coupletsOrder:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="cultural:order:coupletsOrder:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/cultural/order/coupletsOrder/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="coupletsOrderTable"   data-toolbar="#toolbar"></table>
